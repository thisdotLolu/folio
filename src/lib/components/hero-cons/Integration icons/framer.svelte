<div class="border-[#fff] border-[2px] bg-white -rotate-3 rounded-sm shadow-[3px_3px_10px_2px_rgba(0,0,0,0.2)] h-fit w-fit">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M9 20.3334H16V27L9 20.3334Z" fill="#0055FF"/>
