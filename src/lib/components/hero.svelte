...
const links = [
  ...
  <div class="font-inter w-full mt-[60px] md:px-10 px-4 md:flex-row flex-col flex items-start justify-between pt-[50px]">
      <div class='md:w-[70%] w-full'>
        ...
        <span class='text-[#838486] inline-flex items-center font-fraunces font-light'>Product Designer <DesignerSpan/> </span> focused on crafting and delivering <span class="text-[#ccd0d8] bg-[#000] shadow">intuitive</span> user experiences
        </div>
        {:else}
         <div 
        style="animation: fadeInUp 0.6s ease-out forwards; animation-delay: {2 * 0.2}s; opacity: 0; transform: translateY(10px);"
        class="mb-[5px] md:mb-[20px] md:leading-[55px] leading-[45px] animation: fadeInUp tracking-tighter md:tracking-[-3px] text-[2.5rem] md:text-[3rem] font-fraunces font-light">
          a <span class='text-[#838486] inline-flex items-center'>Developer <Span/> </span> and <span class='text-[#838486] inline-flex items-center font-fraunces font-light'>Designer <DesignerSpan/> </span> focused on delivering <span class="text-[#ccd0d8] bg-[#000] shadow-md px-2">exceptional</span> and  <span class='text-[#ccd0d8] bg-[#000] shadow-md px-2'>complex software</span>
        </div>
        {/if}
       ...
       {:else if skill?.toLowerCase() === 'design'}
        <p 
        style="animation: fadeInUp 0.6s ease-out forwards; animation-delay: {3 * 0.2}s; opacity: 0; transform: translateY(10px);"
      ...
      {/if}
        ...
        class='gap-1 text-[#fff] bg-[#000] w-fit p-[10px] h-[45px] rounded-[15px] flex items-center justify-center px-[20px]'>
          Send an email 
          <Mail
          size={14}
          />
